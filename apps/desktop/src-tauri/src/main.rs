...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_document_structure,
            commands::get_document_node_text,
            commands::get_document_range_text,
            commands::get_document_paragraph,
            commands::get_document_headings,
            commands::get_document_resources,
            commands::read_document_resource,
            commands::get_document_citation,
            commands::search_document_canonical,
